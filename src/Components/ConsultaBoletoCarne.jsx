...
function ConsultaBoletoCarne() {
  ...
  const consultaPagamentoBoletoCarne = (pedido, empresa) => {

    var config = {
      method: 'GET',
      url: `${process.env.REACT_APP_PRE_URL_API}/boleto/carne?pedido=${pedido}&empresa=${empresa}`
    };
  ...
  useEffect(() => {
    ...
    consultaPagamentoBoletoCarne(pedido, empresa);
...
export default ConsultaBoletoCarne;